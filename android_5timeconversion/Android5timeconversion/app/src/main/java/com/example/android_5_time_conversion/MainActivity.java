...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener the_Time = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            EditText year = (EditText)findViewById(R.id.time1);
            EditText mouth = (EditText)findViewById(R.id.time2);
            EditText day = (EditText)findViewById(R.id.time3);
            EditText hour = (EditText)findViewById(R.id.time4);
            EditText minute = (EditText)findViewById(R.id.time5);
            EditText secord = (EditText)findViewById(R.id.time6);
